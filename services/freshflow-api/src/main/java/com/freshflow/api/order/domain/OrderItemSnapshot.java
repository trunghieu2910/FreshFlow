...
public final class OrderItemSnapshot {
    ...
    public OrderItemSnapshot(Long productVariantId, String productName, String variantName, Money unitPrice, int quantity) {
        if (productVariantId == null || productVariantId <= 0) {
            throw new IllegalArgumentException("productVariantId must not be null and must be greater than 0");
        }
