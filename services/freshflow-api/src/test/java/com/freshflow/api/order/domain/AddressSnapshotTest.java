...
class AddressSnapshotTest extends AbstractUnitTest {
  ...
  void shouldRejectNullRecipientName() {
    assertThrows(
        ...
        () ->
            new AddressSnapshot(
                null, "0901234567", "12 Nguyen Trai", "Ben Thanh", "District 1", "HCM"));
  }
  ...
  void shouldRejectBlankRecipientName() {
    assertThrows(
        ...
        () ->
            new AddressSnapshot(
                "   ", "0901234567", "12 Nguyen Trai", "Ben Thanh", "District 1", "HCM"));
  }
