...
class OrderPricingCalculatorTest extends AbstractUnitTest {
    ...
    assertThrows(
        ...
        () ->
            calculator.calculate(
                null, OrderPricingCalculator.DiscountType.NONE, BigDecimal.ZERO, deliveryFee));
  }
  ...
  void shouldRejectEmptyItems() {
    assertThrows(
        ...
        () ->
            calculator.calculate(
                new ArrayList<>(),
                OrderPricingCalculator.DiscountType.NONE,
                BigDecimal.ZERO,
                deliveryFee));
  }
  ...
  void shouldRejectNullItemInsideList() {
    ...
    assertThrows(
        ...
        () ->
            calculator.calculate(
                items, OrderPricingCalculator.DiscountType.NONE, BigDecimal.ZERO, deliveryFee));
  }
  ...
  void shouldCalculateSubtotalFromLineTotals() {
    ...
    OrderPricingCalculator.PricingResult result =
        calculator.calculate(
            items, OrderPricingCalculator.DiscountType.NONE, BigDecimal.ZERO, deliveryFee);
  ...
  void shouldCalculateGrandTotalWithoutDiscount() {
    List<OrderItemSnapshot> items =
        List.of(new OrderItemSnapshot(1L, "P1", "V1", new Money(new BigDecimal("30000.00")), 2));
    OrderPricingCalculator.PricingResult result =
        calculator.calculate(
            items, OrderPricingCalculator.DiscountType.NONE, BigDecimal.ZERO, deliveryFee);
  ...
  void shouldCalculateFixedDiscount() {
    ...
    OrderPricingCalculator.PricingResult result =
        calculator.calculate(
            items,
            OrderPricingCalculator.DiscountType.FIXED_AMOUNT,
  ...
  void shouldCalculatePercentageDiscount() {
    ...
    OrderPricingCalculator.PricingResult result =
        calculator.calculate(
            items,
            OrderPricingCalculator.DiscountType.PERCENTAGE,
            new BigDecimal("10"),
            deliveryFee);
  ...
  void shouldRoundPercentageDiscountUsingHalfUp() {
    List<OrderItemSnapshot> items =
        List.of(new OrderItemSnapshot(1L, "P1", "V1", new Money(new BigDecimal("1.00")), 1));
  ...
  void shouldRejectNullDiscountType() {
    List<OrderItemSnapshot> items =
        List.of(new OrderItemSnapshot(1L, "P", "V", new Money(new BigDecimal("10")), 1));
    assertThrows(
        IllegalArgumentException.class,
  ...
  void shouldRejectNullDiscountValue() {
    ...
    assertThrows(
        ...
        () ->
            calculator.calculate(
                items, OrderPricingCalculator.DiscountType.NONE, null, deliveryFee));
  }
  ...
  void shouldRejectNullDeliveryFee() {
    ...
    assertThrows(
        ...
        () ->
            calculator.calculate(
                items, OrderPricingCalculator.DiscountType.NONE, BigDecimal.ZERO, null));
  }
}
